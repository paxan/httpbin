...
template = {
    ...
    "info": {
        ...
        "description": (
            ...
            "<br/> <br/> <b>Run locally: </b> <code>$ docker build . -t httpbin && docker run -p 80:80 httpbin</code>"
        ),
        "version": version,
    },
...
def delay_response(delay):
    """Returns a delayed response (max of 90 seconds).
    ---
    tags:
      - Dynamic data
    parameters:
